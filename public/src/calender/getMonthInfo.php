...
try{
    ...
    $getMonthDiarySql = "SELECT * FROM `diary` WHERE `email` = '$email' AND `d_date` BETWEEN '2022-05-01 00:00:00.000000' AND '2022-05-31 23:59:59.999999'";
    $getMonthDiaryResult = mysqli_fetch_assoc(mysqli_query($conn, $getMonthDiarySql));
